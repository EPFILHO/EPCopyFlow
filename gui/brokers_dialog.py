...
EYE_OPEN_SVG = '''<svg width="24" height="24" viewBox="0 0 24 24"><path fill="green" d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5C21.27 7.61 17 4.5 12 4.5zm0 13c-3.87 0-7.19-2.54-8.48-6C4.81 8.04 8.13 5.5 12 5.5s7.19 2.54 8.48 6c-1.29 3.46-4.61 6-8.48 6zm0-10a4 4 0 100 8 4 4 0 000-8zm0 6.5a2.5 2.5 0 110-5 2.5 2.5 0 010 5z"/></svg>'''
EYE_CLOSED_SVG = '''<svg width="24" height="24" viewBox="0 0 24 24"><path fill="red" d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5C21.27 7.61 17 4.5 12 4.5zm0 13c-3.87 0-7.19-2.54-8.48-6C4.81 8.04 8.13 5.5 12 5.5s7.19 2.54 8.48 6c-1.29 3.46-4.61 6-8.48 6zm0-10a4 4 0 100 8 4 4 0 000-8zm0 6.5a2.5 2.5 0 110-5 2.5 2.5 0 010 5z"/></svg>'''
...
class BrokersDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        self.show_password_btn.setStyleSheet("QToolButton { background: transparent; border: none; }")
    ...
    def _connect_signals(self):
        ...
        for w in [self.name_edit, self.client_edit, self.broker_name_edit, self.login_edit, self.password_edit, self.server_edit]:
    ...
    def _toggle_password_visibility(self, checked):
        ...
        self.show_password_btn.setIcon(svg_icon(EYE_CLOSED_SVG if checked else EYE_OPEN_SVG))
